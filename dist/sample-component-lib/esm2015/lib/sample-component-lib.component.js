...
SampleComponentLibComponent.decorators = [
    { type: Component, args: [{
                ...
                styles: ["input{border:none;padding:15px;font-size:1.2rem}.component-list{display:-webkit-box;display:flex;-webkit-box-orient:vertical;-webkit-box-direction:normal;flex-direction:column}.component-list .component-header{display:-webkit-box;display:flex;-webkit-box-orient:horizontal;-webkit-box-direction:normal;flex-direction:row;-webkit-box-align:center;align-items:center}@media screen and (max-width:425px){.component-list .component-header{flex-wrap:wrap}.component-list .component-header__title{text-align:center}}.component-list .component-header__title{-webkit-box-flex:1;flex-grow:1;padding:10px;text-transform:capitalize;font-size:2rem}.component-list .component-header__search{-webkit-box-flex:1;flex-grow:1;padding:10px;text-align:right}@media screen and (max-width:425px){.component-list .component-header__search{text-align:center}}.component-list .component-body{height:70vh;padding:5px;overflow-y:scroll}.component-list .component-body .component-item{display:-webkit-box;display:flex;-webkit-box-orient:horizontal;-webkit-box-direction:normal;flex-direction:row;-webkit-box-align:center;align-items:center;-webkit-box-pack:justify;justify-content:space-between}.component .component-header{background-color:#3976aa}.component .component-body .component-item .item-description__title{color:#3976aa}"]
            }] }
];
if (false) {
    /** @type {?} */
